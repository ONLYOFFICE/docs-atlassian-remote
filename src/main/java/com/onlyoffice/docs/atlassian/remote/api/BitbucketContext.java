...
@SuperBuilder
public class BitbucketContext extends Context {
    @NonNull
    ...
    public BitbucketContext(
            ...
            final @NonNull @JsonProperty("repositoryId") String repositoryId,
            final @NonNull @JsonProperty("fileId") String fileId,
            final @NonNull @JsonProperty("locale") String locale
    ) {
